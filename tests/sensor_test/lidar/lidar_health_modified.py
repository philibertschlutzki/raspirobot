...
def main():
    ...
    parser.add_argument('--output-dir', default='raspirobot/tests/sensor_test/lidar/result',
                        help='Output-Verzeichnis für 2D-Karte')
    ...
    output_file = os.path.join(args.output_dir, f"lidar_map_2d_{timestamp}.png")
    ...
    try:
        ...
        # 2D-Karte erstellen
        create_2d_map(angles, distances, output_file)
